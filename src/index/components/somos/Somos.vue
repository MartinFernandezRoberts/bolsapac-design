<template>
    <div class="md:mt-6 xl:h-full">
        <div class="h-auto w-auto pr-6">
            ...
            <div class="text-left pl-6 2xl:mt-2 3xl:mt-16">    
                <p class="font-mukta text-sm md:text-base 3xl:text-2xl w300 ">
            ...
            <div class="flex-col md:w-9/12 w-10/12 mt-3">
                ...
                <p class="font-mukta text-justify text-sm md:text-base 3xl:text-2xl w300">
            ...
            <div class="flex-col ml-10 mt-3">
                ...
                <p class=" font-mukta text-justify text-sm md:text-base w300 3xl:text-2xl">

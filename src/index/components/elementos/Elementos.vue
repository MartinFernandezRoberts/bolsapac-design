...
export default {
    ...
    data() {    
        return {
            isActive: true,
            elem: [
                { nombre:'somos', disp:'SOMOS',  dir:'/somos' },
                { nombre:'sustentabilidad', disp:'SUSTENTABILIDAD',  dir:'/sustentabilidad' },
                { nombre:'procesos', disp:'PROCESOS',  dir:'/procesos' },
                { nombre:'contacto', disp:'CONTACTO',  dir:'/contacto' },
            ],
        }
    },
}
